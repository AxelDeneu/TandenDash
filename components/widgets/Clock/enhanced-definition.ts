...
import { TEXT_SIZE_OPTIONS, COLOR_OPTIONS, BACKGROUND_COLOR_OPTIONS, FONT_SIZE_PRESETS } from '@/types/widget-options'
import { z } from 'zod'

export const enhancedClockConfig: EnhancedWidgetConfig = {
  groups: [
    {
      id: 'display',
